...
def run1():
    x = work1.mod("https://cf.qq.com/cp/a20230403three/pc/index.shtml?e_code=535546", get_time.get_formatted_time(16, 38, 0))
    x.run_qiang_once(need_time=True)


def run2():
    x = work2.mod("https://cf.qq.com/cp/a20230403three/pc/index.shtml?e_code=535546", get_time.get_formatted_time(16, 38, 0))
    x.run_qiang_once(need_time=True)
